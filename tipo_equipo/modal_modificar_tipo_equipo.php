...
<div class="card mx-auto" style="width: 35rem; text-align:center; margin-top:8em;border-radius: 10px;">
 <h5 class="card-header">Modificar Tipo de Equipo</h5>
    <h5 class="card-title" style="padding: 10px;"><?=$ficha['descripcion'];?></h5> 
    <form action="editar_tipo_equipo.php" method="POST" class="form-group">
        <div class="card-body">

            <input type="hidden" name="id" value="<?=$id?>" id="">

            <div class="form-group col-md-12">
                        <label for="" class="form-label" style="float:left;">Tipo de Equipo</label>
